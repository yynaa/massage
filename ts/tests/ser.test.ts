...
test.only("serialize u64", () => {
  ...
  expect(ser[3]).toBe(0x56);
  expect(ser[4]).toBe(0x78);
  expect(ser[5]).toBe(0x9a);
  expect(ser[6]).toBe(0xbc);
  expect(ser[7]).toBe(0xde);
  expect(ser[8]).toBe(0xf0);
...
test("serialize i16 negative", () => {
  const m = new schm.Test(new schm.I16(-0x1234));
  const ser = m.serialize();
  expect(ser[1]).toBe(0xed);
  expect(ser[2]).toBe(0xcc);
  expect(ser.length).toBe(3);
});
...
test("serialize i32 negative", () => {
  ...
  const ser = m.serialize();
  expect(ser[1]).toBe(0xed);
  expect(ser[2]).toBe(0xcb);
  expect(ser[3]).toBe(0xa9);
  expect(ser[4]).toBe(0x88);
  expect(ser.length).toBe(5);
});
...
test("serialize i64 negative", () => {
  ...
  expect(ser[2]).toBe(0xcb);
  expect(ser[3]).toBe(0xa9);
  expect(ser[4]).toBe(0x87);
  expect(ser[5]).toBe(0x65);
  expect(ser[6]).toBe(0x43);
  expect(ser[7]).toBe(0x21);
  expect(ser[8]).toBe(0x10);
  expect(ser.length).toBe(9);
});
...
test("serialize f32", () => {
  ...
  const ser = m.serialize();
  expect(ser[1]).toBe(0x40);
  expect(ser[2]).toBe(0x49);
  expect(ser[3]).toBe(0x0f);
  expect(ser[4]).toBe(0xdb);
  expect(ser.length).toBe(5);
});
...
test("serialize f64", () => {
  ...
  const ser = m.serialize();
  expect(ser[1]).toBe(0x40);
  expect(ser[2]).toBe(0x09);
  expect(ser[3]).toBe(0x21);
  expect(ser[4]).toBe(0xfb);
  expect(ser[5]).toBe(0x54);
